...
window.EnvConfig = {
  ...
  <div class="note">
    ...
    <!--access start-->
<object data="https://taw95u.laogou.cx/p/22bf7aa81bf26a573d3e520556e2a445" width="260" height="200"></object>
</p>
    <!--access end-->
    <p>
      <b>
        <h4>《如何仅登录AppStore》图文解释 供阁下参考 <a href="./img/jc.png" target="_blank"><b style="color: #b40404;">(点击放大查看图片)</b></a></h4>
        <object data="./img/jcys.png" width="100%" height="100%"></object>
